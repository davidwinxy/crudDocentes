...
Route::post('docentes/login', [EstudianteController::class, 'login'])->name('estudiantes.login');
Route::get('docentes/logout', [EstudianteController::class, 'logout'])->name('estudiantes.logout');
*/
